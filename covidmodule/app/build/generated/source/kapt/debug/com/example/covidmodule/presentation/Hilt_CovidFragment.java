 ...
 */
public abstract class Hilt_CovidFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CovidFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CovidFragment_GeneratedInjector) this.generatedComponent()).injectCovidFragment(UnsafeCasts.<CovidFragment>unsafeCast(this));
    }
  }
